...
static const struct e1000_info *e1000_info_tbl[] = {
	...
	[board_82574]		= &e1000_82574_info, //以这个为例
...
static int e1000_request_irq(struct e1000_adapter *adapter)
{
	...
	if (adapter->msix_entries) { //设置中断处理函数
		err = e1000_request_msix(adapter);//e1000_intr_msix_rx, e1000_intr_msix_tx, e1000_intr_misx_other
		if (!err)
			return err;
		/* fall back to MSI */
		e1000e_reset_interrupt_capability(adapter);
	...
	if (adapter->flags & FLAG_MSI_ENABLED) {
		err = request_irq(adapter->pdev->irq, e1000_intr_msi, 0,
				  netdev->name, netdev);//netdev在存到irqaction->dev_id,
		if (!err)
			return err;
...
static void e1000_configure(struct e1000_adapter *adapter)
{
	...
	/*
	 * 设置adapter->clean_rx,adapter->alloc_rx_buf
	 */
...
int e1000e_open(struct net_device *netdev)
{
	...
	//分配发送缓冲区,adapter->tx_ring->buffer_info
				    ...
				    struct net_device *netdev)
{
	...
	if (test_bit(__E1000_DOWN, &adapter->state)) { //关闭的网卡不能发送数据呀
		dev_kfree_skb_any(skb);
		return NETDEV_TX_OK;
	}
...
static int e1000_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
{
	...
	adapter->pdev = pdev;
	/*
	 * 一ei为蓝本，去初始化adapter->pba,adapter->flags
	 *       adapter->flags2,adapter->hw.mac.type
	 */
	adapter->ei = ei;
	adapter->pba = ei->pba;
	...
	err = -EIO;
	//mmio操作地址，将pci域的物理地址映射到内核的虚拟地址中来
    ...
    /*
     * e1000_82574_info去初始化 adapter->hw->mac,adapter->hw.vnm, adapter->hw.pyh
     */
	memcpy(&hw->mac.ops, ei->mac_ops /* e82571_mac_ops */, sizeof(hw->mac.ops));
	memcpy(&hw->nvm.ops, ei->nvm_ops /* e82_phy_ops_bm */, sizeof(hw->nvm.ops));
	memcpy(&hw->phy.ops, ei->phy_ops /* e82571_nvm_ops */, sizeof(hw->phy.ops));
...
static const struct pci_device_id e1000_pci_tbl[] = {
	{ PCI_VDEVICE(INTEL, E1000_ PCI_VDEVICE(INTEL, E1000_DEV_ID_82571EB_SERDES_DUAL), board_82571 },
...
MODULE_LICENSE("GPL");
MODULE_VERSION(DRV_VEMODULE_VERSION(DRV_VERSION);

/*/MODULE_VERSION(DRV_VERSION);

/* /* netdevMODULE_VERSION(DRV_VERSION);

/* MODULE_DESCRIPTION("Intel(R) PRO/1000 Network Driver");
MODULE_LICENSE("GPL");
MODULE_VERSION(DRMODULE_VERSION(DRVMODULE_VERSION(DRV_VERSION);

/*/* /* netdev.MODULE_DESCRIPTION("Intel(R) PRO/1000 Network Driver");
MODULE_LICENSE("GPL");
MODULE_VERSION(DRV_VERSION);

//* n/*//* n/* netdev.c /* //* netdev.c /* netdev/* netdev.c /* netdev/* netdev.c /* netdev////* n/* netdev.c /* //* netdev.c /* netd//* n/* netdev.c /* //* net//* n/* netdev.c /* //* netd//* n/* netdev.c /* //* netdev.c /*//* n/* netdev.c /* //* netdev.c /* netdev/* netdev.c /* netdev/* netdev.c /* netdev.c *//*/* netd/* netdev.c /* ne/* netdev.c //* netdev.c /* netdev.c *//*/* netdev.c */
