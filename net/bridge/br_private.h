...
struct net_bridge {
	...
	/*
	 * 链接到net_bridge_port,net_bridge_port链接到net_device
	 *
	 */
...
int br_switchdev_port_vlan_del(struct hdev_frame_unmark(struct sk_buff *skb)
{
...
struct nd_msg *br_isstruct nd_msg *br_is_nd_neigh_msg(sstruct nd_msg *br_is_nd_neigh_msg(struct sk_buff *skb, struct nd_msg *m);
#endif
